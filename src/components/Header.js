  ...
  return (
    <div className="header-mainbox">
      <div className="header-top">
        <div className="header-top-left left">
      ...
      <div className="header-mid">
        <div className="header-mid-left left">
          <div className="hero">
            <h1>{t("heroTitle")}</h1>
            <p> {t("heroMotto")} </p>
        ...
        <div className="header-mid-right right"></div>
      </div>
      <div className="header-bottom">
        <div className="header-bottom-left left"></div>
        <div className="header-bottom-right right"></div>
      </div>
    </div>
  );
}
